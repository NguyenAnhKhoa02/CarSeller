...
function ExpressService() {
    ...
    <Row style={{paddingLeft:"200px", paddingRight:"200px", paddingTop:"20px", textAlign:"justify"}}>
    ...
    <Row style={{paddingLeft:"200px", paddingRight:"200px", textAlign:"justify"}}>
    ...
    <Row style={{paddingLeft:"200px", paddingRight:"200px", paddingBottom:"50px", textAlign:"justify"}}>
        <Col className="textcontain">
